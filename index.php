<?php 
    ...
    $name = 'home';
    $page = 'home';
    $banner= "A Trusted Partner for Real-Time Location Services";
?>
...
<section class="page-content">
    <section class="page-content-item">        
        <section class="container-fluid">
            <div class="row">
                    <div class="page-app-example bg-first-gradiant col-md-12">
                        <div class="left-right-bg">
                            ...
                            <div class="row justify-content-center ">
                                ...
                                <img src="assets/images/airista-example.png" class="img-fluid" alt="Airista" />
                                </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="page-app-example page-app-black">
                            <div class="left-right-bg">
                                ...
                                <div class="row justify-content-center ">
                                    ...
                                    <!-- Column -->
                                    <div class="col-md-12 text-center middle-image">
                                    <img src="assets/images/twig-example.png" class="img-fluid" alt="TWIG Com" />
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="page-app-example page-app-black">
                            <div class="left-right-bg">
                                ...
                                <div class="row justify-content-center ">
                                    ...
                                    <!-- Column -->
                                    <div class="col-md-12 text-center middle-image">
                                    <img src="assets/images/mini-paccs-example.png" class="img-fluid" alt="Mini PACCS" />
                                    </div>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="page-app-example page-app-black bg-gray page-app-last col-md-12">
                        <div class="left-right-bg">
                            <div class="container">
                            <!-- Row  -->
                            <div class="row justify-content-center ">
                                ...
                                <!-- Column -->
                                <div class="col-md-12 text-center middle-image">
                                <img src="assets/images/airista-example.png" class="img-fluid" alt="wrapkit" />
                                </div>
                            </div>
                            </div>
                        </div>
    ...
    <section class="page-content">
        <div class="page-content-item page-bgtext-container bg-gartner">
            <div class="page-content-inner container">
                <div class="row">
    ...
    <section class="page-content">
        <div class="page-content-item page-bottom-banner">
            <img src="assets/images/banner-bottom2.jpg" alt="Banner" class="img-fluid">
        </div>
    </section>
